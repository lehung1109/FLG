  ...
  <div id="content" class="column" role="main">
    ...
    <div class="art-image">
      ...
      <?php if ($user->uid > 0) {
        ...
        <div class="favourite">
          <p>Add this art to folder: <select id="tid"><?php foreach ($list as $row) { ?><option value="<?php echo $row->tid ?>"><?php echo $row->taxonomy_term_data_name ?></option><?php } ?></select><input type="button" value="Add" id="buttonAdd" nid="<?php echo $_GET['nodeId'] ?>" />
            <p>
        </div>
      <?php } ?>
    ...
    <div class="scroll-pane">
      <div class="search-items" style="width:<?php echo $searchWidth ?>px">
        <a class="previous-page page-link search-item <?php echo $prevClass ?>" href="<?php echo $prevPageUrl ?>"><span>
            < previous </span> </a> <?php
