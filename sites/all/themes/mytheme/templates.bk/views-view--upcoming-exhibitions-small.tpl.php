...
<div class="exhibition-list small">
	...
	if ($node) { ?>
		<div class="row">
			...
			<div class="info">
				<a href="<?php echo url('node/' . $node->nid) ?>"><?php echo $node->field_artist_free_text['und'][0]['value'] ?> <span class="title"><?php echo $node->title ?></span></a><br />
				<?php echo $date1 ?> - <?php echo $date2 ?>
			</div>
		</div>
		<?php
	}
